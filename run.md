...
PYTHONPATH=src python3 -m pytest src/eclss_gravity/tests/ -v   # 38 regression tests, pinned to docs/derivation.md (as corrected -- see below)
...
- All 38 tests in `src/eclss_gravity/tests/` regress against numeric values documented in
